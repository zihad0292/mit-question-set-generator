/**
 * Created by Rajesh on 5/29/19. Modified by Zihad Ul Islam Mahdi on 9/4/19
 */
...
import {retrieveSessionInfo} from './actions/userActions';
            ...
            <div>
                ...
                <div className={classes.routeContainer}>
                    <Switch>
                        ...
                        <PrivateRoute path="/dashboard/index_relation/:dbConfig/new" component={CreateIndexRelation} />
                        <PrivateRoute path="/dashboard/index_relation/:index/edit" component={UpdateIndexRelation} />
                        <PrivateRoute path="/dashboard/index_relation" component={IndexRelation} />
                        ...
                        <PrivateRoute path="/dashboard/data-types/all" component={DataTypes} />
                        <PrivateRoute path="/dashboard/data-types/credentials" component={Credentials} />
...
function mapStateToProps(store) {
    return {
        ...
        fetched     : store.userInfo.fetched,
    };
}

function mapDispatchToProps(dispatch) {
    return bindActionCreators({ retrieveSessionInfo }, dispatch)
}
