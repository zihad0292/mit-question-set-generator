/**
 * Created by Zihad Ul Islam Mahdi on 8/26/19. Modified on 9/2/19
 */
...
import {addNewDataType, fetchDataTypes, updateDataType} from '../../../actions/dataTypesActions';
...
class AddNewForm extends Component{
    ...
    handleSubmit(){
        ...
        const {type, selectedDataType, addNewDataType, updateDataType} = this.props;
    ...
    render(){
        ...
        return(
            <CustomSmallPaper>
                ...
                <FormGroup>
                    <FormControlLabel
                        control={<Checkbox name="enabled" checked={this.state.enabled} onChange={this.handleCheckboxChange} value={this.state.enabled} />}
                        label="Enabled"
                    />
                </FormGroup>
                <FormGroup>
                    <FormControlLabel
                        control={<Checkbox name="hasCredentials" checked={this.state.hasCredentials} onChange={this.handleCheckboxChange} value={this.state.hasCredentials} />}
...
function mapDispatchToProps(dispatch) {
    return bindActionCreators({ addNewDataType, fetchDataTypes, updateDataType }, dispatch)
}
