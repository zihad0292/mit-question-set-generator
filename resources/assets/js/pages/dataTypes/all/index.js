/**
 * Created by Zihad Ul Islam Mahdi on 8/26/19. Modified on 9/5/19
 */
...
import {fetchDataTypes, deleteDataType} from '../../../actions/dataTypesActions';
    ...
    renderDataTypeTable(){
        ...
        const columns = [
            ...
            },
            {
                ...
                render: (rowData) => {
                    return(
                        <Chip variant="outlined" color={rowData.enabled ? 'secondary' : 'default'}
                              label={rowData.enabled ? 'Enabled' : 'Disabled'} size="small"
            ...
            },
            {
                ...
                render: (rowData) => {
                    return(
                        <Chip variant="outlined" color={rowData.hasCredentials ? 'secondary' : 'default'}
                              label={rowData.hasCredentials ? 'Yes' : 'No'} size="small"
                              icon={<Icon className={classes.iconWidth}>fiber_manual_record</Icon>} />
                    );
                }
            }
            ...
            Action: props => {
                if(props.action.icon === 'edit'){
                    ...
                    <IconButton aria-label="delete" size="small"
                        disabled={props.data.dataType.toLowerCase() === 'html' || props.data.dataType.toLowerCase() === 'plain' || props.data.dataType.toLowerCase() === 'base64' || props.data.dataType.toLowerCase() === 'encryption' || props.data.dataType.toLowerCase() === 'ftp' || props.data.dataType.toLowerCase() === 'sftp'}
        ...
        return(
            <PageContainer maxWidth="lg">
                ...
                <Modal
                    ...
                    <UpdateDataType selectedDataType={dataTypes[selected]} onUpdateComplete={this.onModalClose}/>
                </Modal>
                <ConfirmDialog
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(styles)(DataTypes));
