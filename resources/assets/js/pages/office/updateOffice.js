/**
 * Created by Zihad Ul Islam Mahdi on 8/20/19.
 */
    ...
    render(){
        ...
        return(
            <Paper className={classes.root}>
                <WidgetTitle>Update Office Info</WidgetTitle>
                <AddNewForm type='update' selectedOffice={this.props.selectedOffice} onComplete={this.onComplete}/>
            </Paper>
        );
    }
}
...
export default withStyles(styles)(UpdateOffice);
