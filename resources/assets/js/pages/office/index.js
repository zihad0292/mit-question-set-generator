/**
 * Created by Rajesh on 6/13/19. Modified by Zihad Ul Islam Mahdi on 9/19/19.
 */
    ...
    renderOfficeRow(){
        ...
        if(offices.length > 0){
            return offices.map((office, idx) => {
                return(
                    <CustomSmallPaper key={"office-item-" + idx} elevation={2} className={classes.dbCardRow}>
        ...
        return(
            <PageContainer maxWidth="lg">
                ...
                <Modal
                    ...
                    <UpdateOffice selectedOffice={offices[selected]} onUpdateComplete={this.onModalClose}/>
                </Modal>
                <ConfirmDialog
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(styles)(Office));
